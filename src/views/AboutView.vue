      ...
      <section
        ...
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi semua nya perkenalkan nama saya agung. web ini di bantu dengan html , css , js dan vue
            untuk menginstal anda harus install dulu node_module. dengan web vue js ini web mu akan semakin bagus untuk dilihat!.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; Keahlian saya tertera di bawah ini untuk mengetahui apa sajakah keahlian saya sebagai web developer
            kalau ada keperluan anda bisa menghubungi saya melalui Instagram dan WhatsApp!..
          </p>
        </div>
