<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Agung</h1>
      <div class="py-2">
        <h1
      ...
      <p class="text-white pr-4 fade-in-from-left">Selamat datang di personal website ku <span class="wave">👋🏼</span></p>
      <br>
      <!-- <button
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-10/12 md:h-auto rounded-full border-4 border-amber-200 pict" src="https://i1.sndcdn.com/avatars-000248291936-634zqi-t500x500.jpg">
    </div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Web Developer", "Full creator", "Informasi portofolio", "Website hosting"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
