    ...
    <div class="flex flex-col-reverse md:flex-row relative">
            ...
            <router-link :to="`/read/${article.slug}/${article.id}`" class="flex w-full bg-[#1e1e1f] border-[#383838] rounded-xl text-left text-white p-5 md:py-7 md:px-8 cursor-pointer hover:bg-[#282828] items-center">
              <div class="w-full pr-4">
                <div class="text-xs mb-1 text-slate-400 flex items-center italic">
                  <div class="h-[1px] w-20 bg-amber-200 md:w-5 aos-init aos-animate mr-2"></div> 21-09-2023
                </div>
                <h1 class="text-sm md:text-md text-amber-200 font-bold mb-2 paraf">Artikel Web</h1>
                <div class="text-sm hidden md:block paraf">Websites can be divided into several, namely portfolio, login and others</div>
              </div>
              <div>
      ...
      <div class="w-full md:w-1/3 h-fit p-8 md:sticky md:top-24">
        ...
        <div class="flex flex-col text-left">
          <div class="bg-clip-text bg-gradient-to-r from-slate-100 to-amber-300 text-transparent">Belajar lah html dari awal, Mulai dari Html ke css dan js. untuk awal belajar saja python karena mudah di pahami
          </div>
